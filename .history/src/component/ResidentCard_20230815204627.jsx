...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className=" grid gap-4 grid-cols-[repeat(auto-fill,_minmax(180px,_1fr))] max-w-[1200px] mx-auto mt-4 transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
