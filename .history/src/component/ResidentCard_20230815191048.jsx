...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className=" m-2 absolute flex-wrap justify-center relative h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
