...
function App() {
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <img className="absolute -z-10 w-full h-[calc(100vh/3)] bg-cover bottom-0" src="./src/assets/RickAndMorty_BigBg002.png" />
      <img className="absolute -z-10 w-full h-[calc(100vh/3)] bg-cover bottom-1/2 translate-y-1/2" src="./src/assets/RickAndMorty_BigBg003.png" />
