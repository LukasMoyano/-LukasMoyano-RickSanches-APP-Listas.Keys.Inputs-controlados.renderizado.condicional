...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    <article
      className="flex flex-col justify-center relative h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90"
    >
      <header className=" absolute bottom-[320px] z-30   w-full ">
        <img
          className="mx-auto w-[320x] aspect-square rounded-full"
