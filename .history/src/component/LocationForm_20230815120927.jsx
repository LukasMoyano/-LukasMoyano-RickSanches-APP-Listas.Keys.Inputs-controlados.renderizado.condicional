  ...
  return (
   ...
   {/* Formulario para ingresar un ID de ubicación */}
    <form onSubmit={handleSubmit} className="mx-auto overflow-hidden flex justify-between w-[300px] rounded-full bg-white">
      ...
      <input
        className="w-2/3 pl-2" // Ancho del 2/3 del formulario, padding izquierdo de 2
      ...
      <button className="text-justify text-center p-2 rounded-full border-[#893446] border-8 w-1/3 bg-yellow-400">
