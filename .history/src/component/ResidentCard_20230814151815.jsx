    ...
    <article className="flex flex-col justify-center relative h-[400px] w-[450px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
      <header className=" absolute bottom-[280px] z-30 w-full  ">
        ...
        <div className="flex item-center p-2">
          <div
            className={`flex items-center justify-center h-14 aspect-square rounded-full ${statusresidentinfo[residentInfo?.status]
              }`}
          >
            {residentInfo?.status}
          </div>
      ...
      <section className=" h-[320px] relative top-0 bg-cover w-full bg-[url(./src/assets/targeta001.png)]">
        ...
        <ul className="absolute top-40 right-1/2 translate-x-1/2">
          <li>
            <span className="font-bold text-[#893446]">Species:</span>
            <span className="text-[color value]"> {residentInfo?.spacies}</span>
          </li>

          <li>
            <span className="text-[rgb(255,255,255)] font-bold">Origin:</span>
            <span className="text-[color value]"> {residentInfo?.origin.name}</span>
