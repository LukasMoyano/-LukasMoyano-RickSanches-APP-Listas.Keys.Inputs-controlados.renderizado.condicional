...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className=" absolute flex-wrap justify-center h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
      {/* Encabezado de la tarjeta */}
      <header className="relativo z-30 w-full">
        {/* Imagen del residente */}
        <img
          className="mt-0 mx-auto w-[200px] aspect-auto rounded-3xl border-8 border-[#893446]"
