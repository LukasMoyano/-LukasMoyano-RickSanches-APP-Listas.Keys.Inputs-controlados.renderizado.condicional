      ...
      <div className="justify-center gap-4 my-4">
            ...
            {Array.from({ length: 3 }, (_, index) => index + 1).map((index) => (
              <div
                ...
                className={classnames(
                  "rounded-full w-24 h-24 border-8 text-center font-nunito font-semibold text-2xl leading-11 text-[#893446]",
                  {
        ...
        <button
          className={classnames(
            "rounded-full w-24 h-24 border-8 text-center font-nunito font-semibold text-2xl leading-11 text-[#893446],
            {
              "bg-[#EDE288]  hover:bg-opacity-50 cursor-pointer transition-opacity": currentPage === 1,
            }
          )}
