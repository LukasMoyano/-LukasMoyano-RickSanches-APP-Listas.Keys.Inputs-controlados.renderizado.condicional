...
const ResidentCard = ({ residentUrl }) => {
  ...
  <article className="flex justify-center relative w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
    ...
    <header className="absolute bottom-[280px] z-30 w-full">
      ...
      <div className="flex item-center p-2">
        ...
        <div
          className={`flex items-center justify-center h-14 w-14 aspect-square rounded-full ${
    ...
    <section className="h-[320px] relative bg-cover w-full bg-[url(./src/assets/targeta001.png)]">
      ...
      <h3 className="top-10 right-1/2 transform translate-x-1/2 absolute text-[#893446] text-center font-nunito text-3xl font-bold">
        {residentInfo?.name}
      </h3>

      {/* Lista de detalles del residente */}
      <section>
        <ul className="grid grid-cols-2 rows-3 absolute top-40 right-1/2 transform translate-x-1/2">
