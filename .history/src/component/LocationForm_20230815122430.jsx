...
export const LocationForm = ({ handleSubmit }) => {
  return (
   ...
   {/* Formulario para ingresar un ID de ubicación */}
    <form onSubmit={handleSubmit} className="border-[#893446] border-8 mx-auto overflow-hidden flex justify-between w-[300px] rounded-full bg-white">
      ...
      <button className="bg-[#EDE288] p-2 text-lg text-center p-2 rounded-full border-[#893446] border-8 w-1/3 bg-[]">
        Let's Go Morty!
      </button>
    </form>
    </section>
