...
function App() {
  ...
  return (
    <main className="contenedor-imagenes flex">
      <img className="w-full h-screen"  src="./src/assets/RickAndMorty_BigBg001.png bg-cover" />
      <img src="w-full h-screen ./src/assets/RickAndMorty_BigBg002.png bg-cover" />
      <img className="center" src="w-full h-screen ./src/assets/RickAndMorty_BigBg003.png.jpg bg-cover" />
