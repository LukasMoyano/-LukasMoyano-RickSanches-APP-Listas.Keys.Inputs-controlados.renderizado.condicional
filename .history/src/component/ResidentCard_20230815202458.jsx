...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className="flex w-[320px] bg-green-400 items-center justify-items-start">
      {/* Encabezado de la tarjeta */}
      <header className="z-30 w-full">
        {/* Imagen del residente */}
        <img
          className="relative mt-10 mx-auto aspect-auto rounded-full border-8 border-[#893446]"
