...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className=" flex-wrap justify-center relative h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90 grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
     ...
     t <section className="relative h-[320px] w-[320px] top-0 bg-cover bg-[url(./src/assets/targea001.png)]">
        ...
        <section className="grid grid-cols-2 grid-rows-3 top-32 left-4">
  {/* Primera fila */}
  <h2 className="capitalize font-bold text-[#893446]">Species:</h2>
  <h3 className="capitalize text-[rgb(255,255,255)]">{residentInfo?.species}</h3>

  {/* Segunda fila */}
  <h2 className="capitalize text-[#893446] font-bold">Origin:</h2>
  <h3 className="capitalize text-[rgb(255,255,255)]">{residentInfo?.origin.name}</h3>

  {/* Tercera fila */}
  <h2 className="text-[#893446] font-bold">Times Appear:</h2>
  <h3 className="capitalize text-[rgb(255,255,255)]">{residentInfo?.episode.length}</h3>
</section>
