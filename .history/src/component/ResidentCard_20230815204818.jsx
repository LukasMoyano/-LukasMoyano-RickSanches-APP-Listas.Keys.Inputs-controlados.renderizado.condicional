...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className=" m-2 relative flex-wrap justify-center h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">

grid gap-4 grid-cols-[repeat(auto-fill,_minmax(180px,_1fr))] max-w-[1200px] mx-auto mt-4



      {/* Encabezado de la tarjeta */}
      <header className="absolute h-full z-30 w-full">


        {/* Imagen del residente */}
        <img
          className="absolute mt-1 mx-auto w-[200px] aspect-auto rounded-3xl border-8 border-[#893446]"
      ...
      <section className="absolute h-[320px] w-[320px] -top-5 bg-cover bg-[url(./src/assets/targeta001.png)]  ">
        ...
        <div className="absolute flex items-center pl-5 pt-10">
          <div
            className={`aspect-square rounded-full border-2  border-spacing-1 flex items-center justify-center capitalize p-1 ${statusresidentinfo[residentInfo?.status]
              }`}
          >
            {residentInfo?.status}
          </div>
