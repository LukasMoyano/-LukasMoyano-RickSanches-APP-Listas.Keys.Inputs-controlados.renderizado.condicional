...
export const ResidentList = ({ residents }) => {
  ...
  return (
    <section className="flex flex-col justify-center relative h-[400px] w-[450px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
