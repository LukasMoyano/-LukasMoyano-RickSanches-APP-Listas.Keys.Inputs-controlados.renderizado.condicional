            ...
            {Array.from({ length: 3 }, (_, index) => index + 1).map((index) => (
              <div
                ...
                className={classnames(
                  "rounded-full border-red-900 w-24 h-24 border-8 text-center font-nunito text-2xl leading-11 text-[#893446]",
                  {
                    "bg-opacity-50": currentPage === index,
                    "bg-[#EDE288]  hover:bg-opacity-50 cursor-pointer transition-opacity font-semibold":
                      currentPage !== index,
                  }
                )}
