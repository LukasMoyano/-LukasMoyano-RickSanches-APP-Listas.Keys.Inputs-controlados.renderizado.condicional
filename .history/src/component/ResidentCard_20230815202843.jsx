...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 w-[320px] bg-green-400 items-center justify-items-start">
      ...
      <section className="relative h-[320px] w-[320px] top-50 bg-cover bg-[url(./src/assets/targeta001.png)]">
