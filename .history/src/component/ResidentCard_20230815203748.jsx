  ...
  return (
    ...
    <article className=" m-2 relative flex-wrap justify-center h-[320px] w-[320px] transform scale-100 transition-transform ease-in-out duration-300 hover:scale-90">
      ...
      <header className="z-30 w-full">
        ...
        <img
          className="relative mt-10 mx-auto w-[200px] aspect-auto rounded-3xl border-8 border-[#893446]"
      ...
      <section className="relative h-[320px] w-[320px] top-0 bg-cover bg-[url(./src/assets/targeta001.png)] rounded-3xl border-10 border-[#893446] ">
