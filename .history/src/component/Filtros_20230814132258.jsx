...
import FilterBtn from './src/component/Filtros/Category/Filter.module.scss/Category/FilterBtn';
...
const Filtros = ({ setStatus, setPageNumber, setGender, setSpecies }) => {
  ...
  return (
    <div className='col-lg-3 col-12 mb-5'>
      ...
      <div className="text-center font-bold mb-0 text-lg">Filtros</div>
