...
useEffect (() => {
  ...
  return (
    <article className='flex flex-col justify-center items-center relative w-[300px]'>
        ...
        <section className=" h-320 absolute top-0 bg-cover w-full bg-[url(./src/assets/targeta001.png)]">
