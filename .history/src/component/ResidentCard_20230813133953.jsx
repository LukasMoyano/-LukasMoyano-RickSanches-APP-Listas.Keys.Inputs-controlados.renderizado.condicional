...
useEffect (() => {
  ...
  return (
    <article className='relative w-[300px]'>
        <header >
            <img className='w-[200px] aspect-square' src={residentInfo?.image} alt=""/>
        ...
        <section className="absolute top-0 bg-cover w-full bg-[url(./src/assets/targeta001.png)]">
