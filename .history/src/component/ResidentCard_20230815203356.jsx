...
const ResidentCard = ({ residentUrl }) => {
  ...
  return (
    ...
    <article className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 h-[300px] w-[300px] bg-green-400 items-center justify-items-start">
      {/* Encabezado de la tarjeta */}
      <header className="z-30 w-full">
        {/* Imagen del residente */}
        <img
          className="relative aspect-auto rounded-full border-8 border-[#893446]"
      ...
      <section className="relative h-[300px] w-[300px] -top-10 bg-cover bg-[url(./src/assets/targeta001.png)]">
