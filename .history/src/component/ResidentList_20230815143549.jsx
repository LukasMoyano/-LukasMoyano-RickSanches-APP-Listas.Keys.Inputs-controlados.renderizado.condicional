...
const PaginationButton = ({ index, currentPage, handlePageChange }) => {
    ...
    <div
      ...
      className={classnames(
        "rounded-full border-[#893446] w-12 h-12 border-8 text-center font-nunito text-2xl text-[#893446]",
        {
          ...
          "bg-[#EDE288] hover:bg-opacity-50 cursor-pointer transition-opacity": isClickable,
        }
      )}
      onClick={() => isClickable && handlePageChange(index)}
    >
      {index}
    </div>
  );
